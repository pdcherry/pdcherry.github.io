...
rna_TE_sensitivity_doe <- optBlock(frml = ~ conc + panel + mass_input, 
                                          withinData = rna_TE_sensitivity_doe, blocksizes = rep(60, 2), nRepeats	= 3)
```
...
rna_TE__blocking_df <- bind_rows(
 mutate(rna_TE_sensitivity_doe$Blocks$B1, "operator" = "Operator A"),
 mutate(rna_TE_sensitivity_doe$Blocks$B2, "operator" = "Operator B"),
) %>%
