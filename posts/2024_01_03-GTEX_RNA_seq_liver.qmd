...
```{r alternate out, include = FALSE, eval = TRUE}
...
```{r alternate out 2, include = FALSE, eval = TRUE}
saveRDS(tissue_DE_results_long, "../tissue_DE_results_liver.rds")
```
...
![hsa00980 Metabolism of xenobiotics by cytochrome P450](hsa00980.pathview.png)
