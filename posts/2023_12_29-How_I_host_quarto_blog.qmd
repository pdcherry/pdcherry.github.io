...
In June of 2024, I was reviewing the `.github/workflows` files and the logs of the GitHub actions, and realized that I was doing *none* of the publish and deploy paths I had described above (@sec-road-less-trodden).
 ...
 - I am following bullet point 3. No notes to past Patrick; even with more experience, I still can't imagine installing reticulate to a virtual machine on a compute note just to publish the next version of a blog.
