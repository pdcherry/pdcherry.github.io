...
I encountered the error "`fatal: the remote end hung up unexpectedly`" while trying to execute `git push`. This occurred both in the terminal and in R Studio's nice git GUI. After [searching up the error](https://stackoverflow.com/questions/15240815/git-fatal-the-remote-end-hung-up-unexpectedly), I was able to fix it by running `git config http.postBuffer 524288000` in my git-enabled project directory. All subsequent git pushes have worked.
