...
categories:
  ...
  - unbalanced DoE
  - causal inference
bibliography: 2024_05_19-emmeans_estimated_marginal_means/2024_05_19-emmeans_estimated_marginal_means.bib
image: "2024_05_19-emmeans_estimated_marginal_means/2024_05_19-emmeans_diff_plot.png"
format:
  html:
    df-print: kable
execute:
...
---
![The diet of pigs contributes to their rate of growth and macromolecular composition. Photo reproduced here from m_takahashi under CC BY-ND 2.0 Deed Attribution-NoDerivs 2.0 Generic](2024_05_19-emmeans_estimated_marginal_means/2024_05_19-emmeans_estimated_marginal_means_pigs_cc.jpg)
...
combined_omm_emm_data <- pigs %>%
  ...
  bind_rows(
    bind_cols(RG,
              inverse(predict(mod4, newdata = RG, interval = "prediction", level = 0.95)) %>%
                as_tibble() %>%
...
combined_omm_emm_plot <- combined_omm_emm_data %>%
  ggplot(aes(y = conc, x = percent, color = source, linetype = analysis,
             group = interaction(source, analysis))) +
  geom_line() +
...
ggsave("2024_05_19-emmeans_estimated_marginal_means/2024_05_19-emmeans_diff_plot.png",
       combined_omm_emm_plot,
