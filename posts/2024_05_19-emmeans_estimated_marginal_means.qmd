...
image: "2024_05_19-emmeans_diff_plot.png"
format:
  html:
    df-print: kable
execute:
...
combined_omm_emm_data <- pigs %>%
  ...
  bind_rows(
          mutate(RG, "conc" = inverse(predict(mod4, newdata = RG))),
          .id = "analysis") %>%
...
ggsave("2024_05_19-emmeans_diff_plot.png", combined_omm_emm_plot,
...
The EMMs vs OMMs tend to differ more for smaller sample sizes (n).
