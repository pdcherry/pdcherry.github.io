...
There are [10 state-wide](https://docs.google.com/spreadsheets/d/1R0pUcktE5WIjjFjpKIJX78gutG6Yl3ijqWNA9IjYuXg/edit?gid=0#gid=0) and 15 city / county ballot propositions this November. (This is actually a small decrease from the predicted 14 state-wide ballot propostions that [had the potnetial to go to the voters as of May](https://sfba.social/@alfredtwu/112375912539901957).) This makes for lots of *data points* for clustering and grouping the political organizations based on their recommendations.
