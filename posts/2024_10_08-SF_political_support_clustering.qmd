...
::: {.callout-warning}
This page is incomplete. The San Francisco Chronicle has yet to publish their endorsements and voting recommendations as of 2024-10-09.
:::
...
```{r message = FALSE}
state_measures <- read_csv(path(exp_imp_path,"2024_10_08-SF_pol_supp_state_full.csv"),
                                show_col_types = FALSE)
SF_measures <- read_csv(path(exp_imp_path,"2024_10_08-SF_pol_supp_local_full.csv"),
                                show_col_types = FALSE)
